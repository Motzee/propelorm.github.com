...
Nous conseillons d'employer [Composer](http://getcomposer.org/) pour gérer les dépendances de votre projet. Pour installer Propel via Composer, créer un fichier `composer.json` à la racine du projet, et y inscrire le contenu suivant :
